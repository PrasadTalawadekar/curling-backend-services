-- ========================================================
-- Curling Mobile Game: Fresh Reset & Create for MySQL Cloud SQL
-- ========================================================
...
DROP TABLE IF EXISTS gd_ad_mob;
DROP TABLE IF EXISTS gd_bot_profile;
DROP TABLE IF EXISTS gd_challenge_module;
DROP TABLE IF EXISTS gd_environment_asset;
DROP TABLE IF EXISTS gd_feature;
DROP TABLE IF EXISTS gd_game_currency;
DROP TABLE IF EXISTS gd_game_details;
DROP TABLE IF EXISTS gd_game_screen;
DROP TABLE IF EXISTS gd_gameflow_config;
DROP TABLE IF EXISTS gd_gameplay_stats;
DROP TABLE IF EXISTS gd_give_away;
DROP TABLE IF EXISTS gd_give_away_item;
DROP TABLE IF EXISTS gd_material;
DROP TABLE IF EXISTS gd_plotted_stone_config;
DROP TABLE IF EXISTS gd_pvp_module;
DROP TABLE IF EXISTS gd_scenario;
DROP TABLE IF EXISTS gd_segment;
DROP TABLE IF EXISTS gd_widget;
DROP TABLE IF EXISTS ud_user_master;
DROP TABLE IF EXISTS analysis_user_daily_activity;
DROP TABLE IF EXISTS gd_broom_asset;
DROP TABLE IF EXISTS gd_environment;
DROP TABLE IF EXISTS gd_game_screen_widget_feature_mapper;
DROP TABLE IF EXISTS gd_gameflow;
DROP TABLE IF EXISTS gd_gameplay_stats_xp_mapper;
DROP TABLE IF EXISTS gd_give_away_feature_mapper;
DROP TABLE IF EXISTS gd_give_away_item_mapper;
DROP TABLE IF EXISTS gd_leaderboard;
DROP TABLE IF EXISTS gd_plotted_stone;
DROP TABLE IF EXISTS gd_rewardhighway_config;
DROP TABLE IF EXISTS gd_rock_asset;
DROP TABLE IF EXISTS gd_surface_material;
DROP TABLE IF EXISTS gd_user_level;
DROP TABLE IF EXISTS gd_user_message;
DROP TABLE IF EXISTS ud_user_give_away;
DROP TABLE IF EXISTS ud_user_stats;
DROP TABLE IF EXISTS ud_user_wallet;
DROP TABLE IF EXISTS gd_broom;
DROP TABLE IF EXISTS gd_challenge_config;
DROP TABLE IF EXISTS gd_leaderboard_reward;
DROP TABLE IF EXISTS gd_pvp_config;
DROP TABLE IF EXISTS gd_rewardhighway;
DROP TABLE IF EXISTS gd_rock;
DROP TABLE IF EXISTS gd_surface;
DROP TABLE IF EXISTS ud_leaderboard_user;
DROP TABLE IF EXISTS ud_user_message_master;
DROP TABLE IF EXISTS gd_challenge;
DROP TABLE IF EXISTS gd_pvp;
DROP TABLE IF EXISTS ud_user_broom;
DROP TABLE IF EXISTS ud_user_rewardhighway;
DROP TABLE IF EXISTS ud_user_rock;
DROP TABLE IF EXISTS ud_user_challenge;
DROP TABLE IF EXISTS ud_user_loadout;
